          ...
          <section class="sign-in">
            <div class="container">
                ...
                <div class="col-6">
                    ...
                    <div class="col-6">
                    <a href="register.php" class="signup-image-link position-absolute ">Create an account <u class=" text-info ">Sign Up</u> </a>
                    </div>
                    <div class="col-6">
...
function map() 
{
    echo '<div class="mapswrapper"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3835.734024718619!2d108.253227!3d15.975260299999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3142108997dc971f%3A0x1295cb3d313469c9!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBDw7RuZyBuZ2jhu4cgVGjDtG5nIHRpbiB2w6AgVHJ1eeG7gW4gdGjDtG5nIFZp4buHdCAtIEjDoG4sIMSQ4bqhaSBo4buNYyDEkMOgIE7hurVuZw!5e0!3m2!1svi!2s!4v1732810635739!5m2!1svi!2s" width="3000" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <a href="https://www.taxuni.com/w9-form/">w9 form</a>
        <style>.mapswrapper{background:#fff;position:relative}.mapswrapper iframe{border:0;position:relative;z-index:2}.mapswrapper a{color:rgba(0,0,0,0);position:absolute;left:0;top:0;z-index:0}</style></div> ';
}
function footers()
{
    echo ' 
    ...
    <section class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a href="#">0935546419</a>
                <a href="#">0329205882</a>
                <a href="#">phutrong2937@gmail.com</a>
                <a href="#">trongpnp.23ceb@vku.udn.vn</a>
                <a href="#">470 Tran Dai Nghia ,Hoa Hai , Ngu Hanh Son , Danang</a>
            </div>
    
            <div class="box">
                <h3>follow us</h3>
                <a href="https://www.facebook.com/phutrong.phamnguyen">Facebook</a>
                <a href="#">Twitter</a>
                <a href="https://www.instagram.com/doofenshmirtz_2937/">Instagram</a>
                <a href="#">Linkedin</a>
            </div>
    
        </div>
    
        <div class="credit"> copyright @ 2024 by <span>Web Developer</span> </div>
